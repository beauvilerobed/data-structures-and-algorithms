...
from file_reader import generate_files, generate_inputs_outputs_cluster,\
                        generate_inputs_outputs_large_cluster


input_files, output_files, assignment, file_path_length = generate_files()
print("finished returning first set of files")
inputs_outputs = generate_inputs_outputs_cluster(input_files, output_files,
                                                 assignment, file_path_length)
print("finished generating first input output files")


largest_clusters_test_cases = '/tests2/*'
input_files2, output_files2, assignment2, file_path_length2 =\
    generate_files(largest_clusters_test_cases)
print("finished returning second set of files")
inputs_outputs2 =\
   generate_inputs_outputs_large_cluster(input_files2, output_files2,
                                         assignment2, file_path_length2)
