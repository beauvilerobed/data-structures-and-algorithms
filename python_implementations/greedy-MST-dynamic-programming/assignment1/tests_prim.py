...
input_files, output_files, assignment, file_path_length = generate_files(prims_test_cases)
inputs_outputs = generate_inputs_outputs_prim(input_files, output_files, assignment, file_path_length)
